...
public class MethodTypesConcept {
	...
	// Method types - void keyword - non-returning method / void is replaced by some dataTypes - returning method
...
//		addition2(); // not allowed to call method with argument blank
		addition2(100,200);
		addition2(34353, 235325);
		
		MethodTypesConcept mtc = new MethodTypesConcept();
//		mtc.substraction("hi", true, 500); //not applicable for the arguments (String, boolean, int)
