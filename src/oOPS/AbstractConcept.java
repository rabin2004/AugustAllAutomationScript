...
public abstract class AbstractConcept {
	...
	// Abstract class VS Class - 
			...
			// 4. can't instantiate (create object) abstract class (create object)
			// 5. if abstract class is being inherited, then abstract method needs to be implemented
	
	public static void test1() { // non-abstract method
...
//		AbstractConcept ac = new AbstractConcept(); // can't instantiate (create object) abstract class (create object)
		test1();
	}
