...
WebDriver driver;
	...
	@Test (priority = 2, enabled = false, groups= {"End-to-End Test"})
	...
	@Test (priority=3, enabled=true, dependsOnMethods="submitBtnEnableAfterCredentials", groups= {"Smoke Test", "Regression Test"})
	...
	@Test (priority = 4, enabled = true, groups={"Smoke Test", "End-to-End Test", "Regression Test"})
